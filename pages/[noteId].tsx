          ...
          <form className="w-full">
              <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="w-full px-3 mb-6">
                  ...
                  <textarea rows={5} className="appearance-none block w-full bg-gray-100 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white mb-5" id="note-field" type="text" placeholder="Main text" onChange={(e) => setSingleNote({...singleNote, noteField: e.target.value })} value={singleNote?.noteField}></textarea>
